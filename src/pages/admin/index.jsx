...
const Dashboard = () => {
  return (
    <div className="px-2 lg:px-10">
      <h1 className="font-semibold text-xl mb-8">Home</h1>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col lg:flex-row gap-4 md:h-[500px] h-[1000px]">
          <div className="flex flex-col w-full lg:w-2/6 h-full ">
            <h1 className="font-semibold">
              Jumlah Object yang di scan hari ini
            </h1>
        ...
        <div className="flex">
          <div className="w-full">
            ...
            <div className=" w-full h-[400px] p-4 bg-white rounded-lg border-2 border-slate-800">
              <div className="flex flex-col size-full">
                <ChartLine />
              </div>
            </div>
